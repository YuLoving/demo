...
@RocketMQMessageListener(
        ...
        consumerGroup = RocketMqBasicConstant.MY_CONSUMER_GROUP+"DELAY",
        selectorType = SelectorType.TAG,
        selectorExpression = RocketMqBasicConstant.MY_DELAY_TAG
)*/
public class DemoConsumerDelay implements RocketMQListener<DemoMessage> {
